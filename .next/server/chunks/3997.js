...
// UNUSED EXPORTS: SignInWithMetamaskButton
...
function withMaxAllowedInstancesGuard(WrappedComponent, name, error) {
  ...
  const Hoc = (props) => {
    ...
    return /* @__PURE__ */ react_experimental_default().createElement(WrappedComponent, { ...props });
  };
...
const createContextAndHook = (displayName, options) => {
  ...
  const Ctx = react_experimental_default().createContext(void 0);
  Ctx.displayName = displayName;
  const useCtx = () => {
    const ctx = react_experimental_default().useContext(Ctx);
...
const IS_REACT_LEGACY = !react_experimental_.useId;
...
const useIsomorphicLayoutEffect = IS_SERVER ? react_experimental_.useEffect : react_experimental_.useLayoutEffect;
...
const SWRConfigContext = (0,react_experimental_.createContext)({});
const SWRConfig = (props)=>{
    const { value  } = props;
    const parentConfig = (0,react_experimental_.useContext)(SWRConfigContext);
    const isFunctionalConfig = isFunction(value);
    const config = (0,react_experimental_.useMemo)(()=>isFunctionalConfig ? value(parentConfig) : value, [
        isFunctionalConfig,
        parentConfig,
        value
    ]);
    // Extend parent context values and middleware.
    const extendedConfig = (0,react_experimental_.useMemo)(()=>isFunctionalConfig ? config : mergeConfigs(parentConfig, config), [
        isFunctionalConfig,
        parentConfig,
        config
    ]);
    ...
    const cacheContextRef = (0,react_experimental_.useRef)(UNDEFINED);
    ...
    return (0,react_experimental_.createElement)(SWRConfigContext.Provider, mergeObjects(props, {
...
const setupDevTools = ()=>{
    if (enableDevtools) {
        // @ts-expect-error
        window.__SWR_DEVTOOLS_REACT__ = react_experimental_;
    }
};
...
const useSWRConfig = ()=>{
    return mergeObjects(defaultConfig, (0,react_experimental_.useContext)(SWRConfigContext));
};
...
const dist_use = react_experimental_.use || ((promise)=>{
...
const useSWRHandler = (_key, fetcher, config)=>{
    ...
    const initialMountedRef = (0,react_experimental_.useRef)(false);
    // If the hook is unmounted already. This will be used to prevent some effects
    // to be called after unmounting.
    const unmountedRef = (0,react_experimental_.useRef)(false);
    // Refs to keep the key and config.
    const keyRef = (0,react_experimental_.useRef)(key);
    const fetcherRef = (0,react_experimental_.useRef)(fetcher);
    const configRef = (0,react_experimental_.useRef)(config);
    const getConfig = ()=>configRef.current;
    const isActive = ()=>getConfig().isVisible() && getConfig().isOnline();
    const [getCache, setCache, subscribeCache, getInitialCache] = createCacheHelper(cache, key);
    const stateDependencies = (0,react_experimental_.useRef)({}).current;
    ...
    const getSnapshot = (0,react_experimental_.useMemo)(()=>{
    ...
    const cached = (0,shim.useSyncExternalStore)((0,react_experimental_.useCallback)((callback)=>subscribeCache(key, (current, prev)=>{
    ...
    const laggyDataRef = (0,react_experimental_.useRef)(data);
    ...
    const revalidate = (0,react_experimental_.useCallback)(async (revalidateOpts)=>{
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
    const boundMutate = (0,react_experimental_.useCallback)(// Use callback to make sure `keyRef.current` returns latest result every time
    (...args)=>{
    ...
    (0,react_experimental_.useDebugValue)(returnedData);
...
const OrganizationProvider = ({
  ...
  return /* @__PURE__ */ react_experimental_default().createElement(dist_SWRConfig, { value: swrConfig }, /* @__PURE__ */ react_experimental_default().createElement(
...
function ClerkContextProvider(props) {
  ...
  const [state, setState] = react_experimental_default().useState({
    client: clerk.client,
  ...
  const clerkCtx = react_experimental_default().useMemo(() => ({ value: clerk }), [clerkLoaded]);
  const clientCtx = react_experimental_default().useMemo(() => ({ value: state.client }), [state.client]);
  const {
    sessionId,
    session,
    userId,
  ...
  const authCtx = react_experimental_default().useMemo(() => {
    const value = { sessionId, userId, actor, orgId, orgRole, orgSlug };
    return { value };
  }, [sessionId, userId, actor, orgId, orgRole, orgSlug]);
  const userCtx = react_experimental_default().useMemo(() => ({ value: user }), [userId, user]);
  const sessionCtx = react_experimental_default().useMemo(() => ({ value: session }), [sessionId, session]);
  const organizationCtx = react_experimental_default().useMemo(() => {
    const value = {
      organization,
      lastOrganizationInvitation,
      lastOrganizationMember
  ...
  return (
    // @ts-expect-error
    /* @__PURE__ */ react_experimental_default().createElement(IsomorphicClerkContext.Provider, { value: clerkCtx }, /* @__PURE__ */ react_experimental_default().createElement(ClientContext.Provider, { value: clientCtx }, /* @__PURE__ */ react_experimental_default().createElement(SessionContext.Provider, { value: sessionCtx }, /* @__PURE__ */ react_experimental_default().createElement(OrganizationProvider, { ...organizationCtx.value }, /* @__PURE__ */ react_experimental_default().createElement(AuthContext.Provider, { value: authCtx }, /* @__PURE__ */ react_experimental_default().createElement(UserContext.Provider, { value: userCtx }, children))))))
  );
}
const useLoadedIsomorphicClerk = (options) => {
  const [loaded, setLoaded] = react_experimental_default().useState(false);
  const isomorphicClerk = react_experimental_default().useMemo(() => IsomorphicClerk.getOrCreateInstance(options), []);
  react_experimental_default().useEffect(() => {
...
const StructureContext = react_experimental_default().createContext(void 0);
StructureContext.displayName = "StructureContext";
const useStructureContext = () => {
  const structureCtx = react_experimental_default().useContext(StructureContext);
...
const LoadedGuarantee = ({ children }) => {
  ...
  if (structure.guaranteedLoaded) {
    return /* @__PURE__ */ react_experimental_default().createElement((react_experimental_default()).Fragment, null, children);
  }
  return /* @__PURE__ */ react_experimental_default().createElement(StructureContext.Provider, { value: StructureContextStates.guaranteedLoaded }, children);
};
...
function ClerkProviderBase(props) {
  ...
  return /* @__PURE__ */ react_experimental_default().createElement(StructureContext.Provider, { value: StructureContextStates.noGuarantees }, /* @__PURE__ */ react_experimental_default().createElement(
...
const withClerk = (Component, displayName) => {
  ...
  const HOC = (props) => {
    ...
    return /* @__PURE__ */ react_experimental_default().createElement(LoadedGuarantee, null, /* @__PURE__ */ react_experimental_default().createElement(
      Component,
      {
        ...props,
        clerk
...
const WithClerk = ({ children }) => {
  ...
  return /* @__PURE__ */ react_experimental_default().createElement(LoadedGuarantee, null, children(clerk));
};
...
class Portal extends (react_experimental_default()).PureComponent {
  constructor() {
    super(...arguments);
    this.portalRef = react_experimental_default().createRef();
  }
  ...
  render() {
    return /* @__PURE__ */ react_experimental_default().createElement("div", { ref: this.portalRef });
  }
}
const SignIn = withClerk(({ clerk, ...props }) => {
  return /* @__PURE__ */ react_experimental_default().createElement(
    Portal,
    {
...
const ClerkLoaded = ({ children }) => {
  ...
  return /* @__PURE__ */ react_experimental_default().createElement(LoadedGuarantee, null, children);
};
...
const MultisessionAppSupport = ({ children }) => {
  ...
  return /* @__PURE__ */ react_experimental_default().createElement((react_experimental_default()).Fragment, { key: session ? session.id : "no-users" }, children);
};
...
const WithUser = ({ children }) => {
  ...
  return /* @__PURE__ */ react_experimental_default().createElement((react_experimental_default()).Fragment, null, children(user));
};
...
const WithSession = ({ children }) => {
  ...
  return /* @__PURE__ */ react_experimental_default().createElement((react_experimental_default()).Fragment, null, children(session));
};
...
const assertSingleChild = (children) => (name) => {
  try {
    return react_experimental_default().Children.only(children);
  } catch (e) {
...
const normalizeWithDefaultValue = (children, defaultText) => {
  ...
  if (typeof children === "string") {
    children = /* @__PURE__ */ react_experimental_default().createElement("button", null, children);
  }
  return children;
};
...
const SignInButton = withClerk(({ clerk, children, ...props }) => {
  ...
  return react_experimental_default().cloneElement(child, childProps);
}, "SignInButton");
...
const useAuth = () => {
  ...
  const isomorphicClerk = useIsomorphicClerkContext();
  const getToken = (0,react_experimental_.useCallback)(createGetToken(isomorphicClerk), [isomorphicClerk]);
  const signOut = (0,react_experimental_.useCallback)(createSignOut(isomorphicClerk), [isomorphicClerk]);
...
const infinite = (useSWRNext)=>(getKey, fn, config)=>{
        const didMountRef = (0,react_experimental_.useRef)(false);
        ...
        const getSnapshot = (0,react_experimental_.useCallback)(()=>{
        ...
        (0,shim.useSyncExternalStore)((0,react_experimental_.useCallback)((callback)=>{
        ...
        const resolvePageSize = (0,react_experimental_.useCallback)(()=>{
        ...
        const lastPageSizeRef = (0,react_experimental_.useRef)(resolvePageSize());
        ...
        const mutate = (0,react_experimental_.useCallback)(// eslint-disable-next-line func-names
        function(data, opts) {
            // When passing as a boolean, it's explicitly used to disable/enable
            // revalidation.
        ...
        // Extend the SWR API
        const setSize = (0,react_experimental_.useCallback)((arg)=>{
            // It is possible that the key is still falsy.
            if (!infiniteKey) return EMPTY_PROMISE;
...
const useWithSafeValues = (params, defaultValues) => {
  ...
  const initialPageRef = (0,react_experimental_.useRef)(
    shouldUseDefaults ? defaultValues.initialPage : params?.initialPage ?? defaultValues.initialPage
  );
  const pageSizeRef = (0,react_experimental_.useRef)(shouldUseDefaults ? defaultValues.pageSize : params?.pageSize ?? defaultValues.pageSize);
  const newObj = {};
...
const usePagesOrInfinite = (params, fetcher, options, cacheKeys) => {
  const [paginatedPage, setPaginatedPage] = (0,react_experimental_.useState)(params.initialPage ?? 1);
  const initialPageRef = (0,react_experimental_.useRef)(params.initialPage ?? 1);
  const pageSizeRef = (0,react_experimental_.useRef)(params.pageSize ?? 10);
  ...
  const page = (0,react_experimental_.useMemo)(() => {
    if (triggerInfinite) {
      return size;
    }
    return paginatedPage;
  }, [triggerInfinite, size, paginatedPage]);
  const fetchPage = (0,react_experimental_.useCallback)(
    (numberOrgFn) => {
      if (triggerInfinite) {
  ...
  const data = (0,react_experimental_.useMemo)(() => {
    if (triggerInfinite) {
      return swrInfiniteData?.map((a) => a?.data).flat() ?? [];
    }
    return swrData?.data ?? [];
  }, [triggerInfinite, swrData, swrInfiniteData]);
  const count = (0,react_experimental_.useMemo)(() => {
    if (triggerInfinite) {
  ...
  const fetchNext = (0,react_experimental_.useCallback)(() => {
    fetchPage((n) => Math.max(0, n + 1));
  }, [fetchPage]);
  const fetchPrevious = (0,react_experimental_.useCallback)(() => {
    fetchPage((n) => Math.max(0, n - 1));
  }, [fetchPage]);
...
function useMagicLink(resource) {
  const { startMagicLinkFlow, cancelMagicLinkFlow } = react_experimental_default().useMemo(() => resource.createMagicLinkFlow(), [resource]);
  react_experimental_default().useEffect(() => {
...
var useSafeLayoutEffect = __webpack_require__(54886);
...
const useAwaitableNavigate = () => {
  ...
  return (0,react_experimental_.useCallback)((to) => {
...
const ClientClerkProvider = (props) => {
  ...
  return /* @__PURE__ */ react_experimental_default().createElement(NextOptionsContext/* ClerkNextOptionsProvider */.f, { options: mergedProps }, /* @__PURE__ */ react_experimental_default().createElement(esm/* ClerkProvider */.El, { ...mergedProps }));
};
...
module.exports = createProxy("D:\\Visual Studio\\threads\\node_modules\\next\\dist\\client\\components\\app-router.js");
 //# sourceMappingURL=app-router.js.map
 ...
 */
var e=__webpack_require__(17640);function h(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var k="function"===typeof Object.is?Object.is:h,l=e.useState,m=e.useEffect,n=e.useLayoutEffect,p=e.useDebugValue;function q(a,b){var d=b(),f=l({inst:{value:d,getSnapshot:b}}),c=f[0].inst,g=f[1];n(function(){c.value=d;c.getSnapshot=b;r(c)&&g({inst:c})},[a,d,b]);m(function(){r(c)&&g({inst:c});return a(function(){r(c)&&g({inst:c})})},[a]);p(d);return d}
