...
// UNUSED EXPORTS: FormDescription, useFormField
...
const Label = /*#__PURE__*/ react_experimental_.forwardRef(({ className, ...props }, ref)=>/*#__PURE__*/ jsx_runtime_.jsx(react_label_dist/* Root */.f, {
        ref: ref,
...
const FormFieldContext = /*#__PURE__*/ react_experimental_.createContext({});
...
const useFormField = ()=>{
    const fieldContext = react_experimental_.useContext(FormFieldContext);
    const itemContext = react_experimental_.useContext(FormItemContext);
...
const FormItemContext = /*#__PURE__*/ react_experimental_.createContext({});
const FormItem = /*#__PURE__*/ react_experimental_.forwardRef(({ className, ...props }, ref)=>{
    const id = react_experimental_.useId();
...
const FormLabel = /*#__PURE__*/ react_experimental_.forwardRef(({ className, ...props }, ref)=>{
...
const FormControl = /*#__PURE__*/ react_experimental_.forwardRef(({ ...props }, ref)=>{
...
const FormDescription = /*#__PURE__*/ react_experimental_.forwardRef(({ className, ...props }, ref)=>{
...
const FormMessage = /*#__PURE__*/ react_experimental_.forwardRef(({ className, children, ...props }, ref)=>{
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("p", {
        ref: ref,
        id: formMessageId,
        className: (0,utils.cn)("text-sm font-medium text-red-500 dark:text-red-900", className),
        ...props,
        children: body
    });
});
